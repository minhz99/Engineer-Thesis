...
\usetikzlibrary{calc, shapes.geometric, arrows.meta, positioning, shadows} % Thêm các thư viện TikZ cần thiết
% \usepackage{ulem}   % Cho \sout (gạch ngang chữ)
% \usepackage{cancel} % Cho \cancel (gạch ngang biểu thức toán)
\usepackage{pgfplots} % Vẽ biểu đồ
\pgfplotsset{compat=1.18}
\usepackage{pgf-pie} % Vẽ biểu đồ tròn
