...
\textbf{(ii) Sản phẩm nhiệt phân:} Từ $m_{\text{RDF cấp lò}} = 39{,}41$ t/ngày RDF đầu vào, tỷ lệ sản phẩm phân bố: dầu thô chiếm khoảng 45\% khối lượng RDF, khí không ngưng khoảng 30\%, than carbon khoảng 25\%. Tổng lượng dầu thô sau ngưng tụ đạt khoảng 17,73 t/ngày, trong đó 14,18 t/ngày sau chưng cất và tinh chế có thể sử dụng trực tiếp cho động cơ diesel.

\textbf{(iii) Cân bằng năng lượng và công suất điện:} Công suất điện tinh thiết kế $W_{e,net} \approx 1{,}52$--$1{,}54$ MW (ròng) sau khi trừ khoảng 30\% phụ tải tự dùng. Phân tích độ nhạy xác nhận phương án vẫn duy trì công suất điện ròng trên 1,2 MW ngay cả ở điều kiện bất lợi nhất.
