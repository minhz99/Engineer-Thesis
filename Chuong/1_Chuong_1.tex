...
Đối với khí thải, các nguồn phát sinh từ buồng đốt gia nhiệt, đốt khí không ngưng, hệ thống sấy, chưng cất và động cơ diesel phải được thiết kế để đáp ứng \textbf{QCVN 19:2024/BTNMT} -- Quy chuẩn kỹ thuật quốc gia về khí thải công nghiệp \cite{QCVN19_2024_BTNMT}. Các thông số cần kiểm soát chính gồm bụi tổng số, bụi mịn, khí axit, \ce{NO_x}, \ce{SO2}, \ce{CO}, kim loại nặng và dioxin/furan. Về quản lý vận hành, nhà máy cần bố trí quan trắc định kỳ và, khi thuộc đối tượng bắt buộc, lắp đặt hệ thống giám sát khí thải liên tục để theo dõi các thông số chính.
